...
if __name__ == "__main__":
    ...
    try:
        ...
        trainer = dqn.RLTrainer(env_entry_point, Snake, input_shape, 4, output_dir, num_episode=args.iteration,
        ...
        if bool(args.gen_from_scratch):
            log.info("Generating 2000 sample data")
            trainer.gen_sample_data(10000)
            # arr = trainer.select_top_n_weights(1)

        # for i in range(20):
        #     trainer.training_one_model(arr[-1])
